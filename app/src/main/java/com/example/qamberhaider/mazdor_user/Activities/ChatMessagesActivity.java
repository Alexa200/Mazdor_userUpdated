package com.example.qamberhaider.mazdor_user.Activities;
...
import com.example.qamberhaider.mazdor_user.Adatper.MessagesAdapter;
import com.example.qamberhaider.mazdor_user.Listdata_Pro;
import com.example.qamberhaider.mazdor_user.Model.ChatMessage;
import com.example.qamberhaider.mazdor_user.Model.UserList;
import com.example.qamberhaider.mazdor_user.R;
...
import static com.example.qamberhaider.mazdor_user.Pro_RecycleviewAdapter.KEY_NAME;
import static com.example.qamberhaider.mazdor_user.Pro_RecycleviewAdapter.KEY_UID;
...
//        queryRecipientName(mReceiverId);
    ...
    private void queryRecipientName(final String receiverId){
        ...
        mUsersRef.child(receiverId).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                Listdata_Pro listdata_pro = dataSnapshot.getValue(Listdata_Pro.class);
                mReceiverName = listdata_pro.getPrFirstName();
